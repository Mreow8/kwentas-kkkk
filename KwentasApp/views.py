...
def login_view(request):
    ...
    return render(request, 'KwentasApp/login.html', {'settings': settings})
...
def health(request):
    return HttpResponse("OK 200 Response, KwentasKlaras is running successfully, Healthy and Ready to Serve", status=200)
